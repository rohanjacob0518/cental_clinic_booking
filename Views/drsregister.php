  ...
  <!-- Container wrapper -->
    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="col-lg-12 col-xl-11">
                    ...
                    <h2 class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">New Doctor Register</h2>
                        <div class="card-body p-md-3">
                            <div class="row justify-content-center">
                                    ...
                                    <form class="mx-1 mx-md-4" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                <input type="text" name="username" id="form3Example1c" class="form-control shadow p-3" placeholder="Doctor Name" required />    
                                            </div>
                                        </div>
                                        <div class="d-flex flex-row align-items-center mb-4 ">
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                <input type="email" name="email" id="form3Example3c" class="form-control shadow p-3" placeholder="Doctor Email" required />
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-10 col-lg-8 col-xl-4  order-1 order-lg-2">

                                    <img src="https://i.pinimg.com/originals/cd/e2/9e/cde29ec855225656a3fa4d5f4b01227e.gif" class="img-fluid" alt="Sample image">
    ...
    <?php
        ...
        if ($password == $cPassword) {
            $sql ="INSERT INTO drslogindetails (dr_name,dr_email,dr_password,dr_gender) VALUES ('$userName','$email','$password','$gend')";
